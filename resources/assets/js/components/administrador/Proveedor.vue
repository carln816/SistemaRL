<template>
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"> <i class="fa fa-address-book" aria-hidden="true"></i> <strong>Proveedores</strong></li>
            </ol>
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <button type="button" class="btn btn-success" @click="abrirModal('proveedor','registrar')"  v-if="idrol==1">
                            ...
                            <tbody>
                                <tr v-for="proveedor in arrayProveedor" :key="proveedor.id">
                                    <td v-if="idrol==1">
                                        ...
                                        <template v-if="proveedor.condicion"> <!--si la condicion es 1 lo que hago es moestro un boton para desactivar el metodo -->
                                        ...
                                        <template v-else><!--si la categoria no esta activa, mostrate un boton para llamar al metodo activar-->
                                            <button type="
                                            button" class="btn btn-primary active btn-sm" @click="activarProveedor(proveedor.id)">
                                                <i class="icon-check"></i>
                                            </button>
                                        </template>
                                    </td>
                                    <td v-text="proveedor.nombre"></td><!-- esto nos mostrara el nombre de la categoria -->
                                    ...
                                    <td>
                                        <div v-if="proveedor.condicion"><!--  si la condicion es igual 1-->
                ...
                <div class="modal-dialog modal-primary modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" v-if="tipoAccion==1" class="btn btn-primary" @click="registrarProveedor()">Crear</button>
    ...
    export default {
        data (){
            return {
                ...
                proveedor_id: 0,
                nombre : '',
                tipo_documento : 'Cedula de Juridica',
                num_documento : '',
                direccion : '',
                telefono : '',
                email : '',
        ...
        methods : {
            listarProveedor (page,buscar,criterio){
                ...
                axios.get(url).then(function (response) { //mediante el metodo de axios obtengo todos los registros de la tabla categorias
                    ...
                    me.arrayProveedor = respuesta.proveedores.data;// almacene todos el contenido del objeto response
            ...
            cambiarPagina(page,buscar,criterio){
               let me = this;
                ...
                me.listarProveedor(page,buscar,criterio);// le envia valores al metodo
            },
            registrarProveedor(){
               ...
               axios.post('/proveedor/registrar',{
                ...
                // si se ejecuta de manera correcta llamamos al metodo cerrarmodal y listarcategoria para actualizar el listado
                    me.cerrarModal();
                    me.listarProveedor(1,'','nombre');//le enviamos qe muestre nuestra primera pagina el fltro
                    swal(
                        'Registrado!!!',
                    ...
                    swal(
                        'Duplicado!!!',
                        'Ya existe un Proveedor con ese numero de identificacion',
                        'error'
                    )
                });
            },
            ...
            validarProveedor(){
                ...
                //si tengo un error evaluamos nuestro array y nuestra variable error Proveedor va a pasar 1 cuando tenga al menos 1 error.
            ...
            cerrarModal(){
                ...
                this.tituloModal='';
                this.nombre='';
                this.tipo_documento='Cedula Juridica';
                this.num_documento='';
                this.direccion='';
                this.telefono='';
                this.email='';
            ...
            abrirModal(modelo, accion, data = []){ //estructura multiple donde evalua el parametro
                switch(modelo){// en caso el texto sea igual al modelo categoria se agrega otra seleccion selectiva
                    case "proveedor":   // case que validad que nuestra variable sea igual a categoria 
                    {
                        switch(accion){ // nos sirve para evaluar nuestro segundo parametro y se evaluara dependiendo del caso
                            case 'registrar':
                            {
                                ...
                                this.nombre= '';
                                this.tipo_documento='Cedula de Juridica';
                                this.num_documento='';
                                this.direccion='';
                                this.telefono='';
                                this.email='';
