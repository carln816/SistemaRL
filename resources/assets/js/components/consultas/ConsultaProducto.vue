<template>
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"> <i class="fa fa-book" aria-hidden="true"></i> <strong>Reportes Productos</strong></li>
            </ol>
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                ...
                                <tr v-for="producto in arrayProducto" :key="producto.id">
                                    <td>
                                        <button type="button" @click="consuPdf(producto.id)" class="btn btn-info">
                                            <i class="fa fa-file-pdf-o" aria-hidden="true"></i>
                                        </button>
                                    </td>
