<template>
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"> <i class="fa fa-tasks" aria-hidden="true"></i> <strong>Reportes Categorias</strong></li>
            </ol>
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                ...
                                <tr v-for="categoria in arrayCategoria" :key="categoria.id">
                                    <td>
                                        <button type="button" @click="consuPdf(categoria.id)" class="btn btn-info">
                                            <i class="fa fa-file-pdf-o" aria-hidden="true"></i>
                                        </button>
                                    </td>
    ...
    export default {
        ...
        methods : {
            ...
            consuPdf(id){//hace referencia a la url que hace referencia nuestro pdf con el metodo open
                ...
                window.open('http://127.0.0.1:8000/categoria/consuPdf/' + id + ',' + '_blank');
