<template>
            ...
            <ol class="breadcrumb">
               <li class="breadcrumb-item"> <i class="fa fa-address-book" aria-hidden="true"></i> <strong>Reportes Proveedores</strong></li>
            </ol>
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <button type="button" @click="cargarPdf(proveedor_id)" class="btn btn-danger">
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="proveedor in arrayProveedor" :key="proveedor.id">
                                    <td>
                                        <button type="button" @click="consuPdf(proveedor.id)" class="btn btn-info">
    ...
    export default {
        ...
        methods : {
            ...
            consuPdf(id){//hace referencia a la url que hace referencia nuestro pdf con el metodo open
                window.open('http://127.0.0.1:8000/proveedor/consuPdf/' + id + ',' + '_blank');
