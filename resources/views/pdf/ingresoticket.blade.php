    ...
    <div class="zona_impresion">
        ...
        <table border="0" align="center" width="300px">
            <tr>
                ...
                .::<strong> COOPERATIVA DE PRODUCCIÓN, INDUSTRIALIZACIÓN Y </strong>::.<strong> COMERCIALIZACIÓN DE LÁCTEOS Y SERVICIOS MÚLTIPLES </strong>
                <br>DE LA ZONA NORTE-NORTE, R.L.<br>Upala, Alajuela, Costa Rica.<br>Tel.: 2470-3000
                <br>Correo: coopelacteos@gmail.com</p>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Nº de ingreso: {{$v->serie_comprobante}}</td>
            </tr>    
        </table>
        @endforeach
        <br>
        ...
        <table border="0" align="center" width="300px">
            ...
            <tr>
                <td>{{$det->cantidad}}</td>
                <td align="center">{{$det->materia}}</td>
            ...
            <tr>
            <td colspan="3" align="center">Cooperativa Coopelácteos RL</td>
            </tr>            
        </table>
        <br>
        </div>
