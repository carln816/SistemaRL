    ...
    <div class="zona_impresion">
        ...
        <table border="0" align="center" width="300px">
            <tr>
                ...
                .::<strong> Cooperativa Coopelácteos RL </strong>::.<br>San Fernando, Upala<br>Telefono : (+506)86300701<br>Telefono : 24601052<br>Email:cooperl@gmail.com</p>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Nº de venta: {{$v->serie_comprobante}}</td>
            </tr>    
        </table>
        @endforeach
        <br>
